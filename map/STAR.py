...
def star(genome, fastq_file, output_folder, name, cpu=1, verbose=True):
    """
    ...
    command = "pybio.star %s %s %s %s %s" % (output_folder, genome_folder, os.path.abspath(fastq_file), name, cpu)
    if verbose:
        print command
